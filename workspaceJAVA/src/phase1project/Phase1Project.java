...
public class Phase1Project {
    ...
    private static final String WELCOME_PROMPT =
            ...
            "\nMAIN MENU - Select one option: \n"+
                    "1.Files list in the directory\n"+
    ...
    void showSecondaryMenu() {
        ...
        try(Scanner scanner = new Scanner(System.in))
        {
            ...
            switch (option){
                case '1' : {
                    System.out.print("File Adding.....Enter a File Name : ");
                    String filename = scanner.next().trim().toLowerCase();
                    addFile(filename);
                    break;
                }
                case '2' : {
                    System.out.print("File Deleting......Enter a File Name : ");
                    String filename = scanner.next().trim();
                    deleteFile(filename);
                    break;
                }
                case '3' : {
                    System.out.print("File Searching.....Enter a File Name : ");
                    String filename = scanner.next().trim();
                    searchFile(filename);
                    break;
                }
